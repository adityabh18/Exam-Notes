...
px-8 py-6 items-center flex justify-between
md:items-center gap-4 flex-wrap
        ...
        <AnimatePresence>
          {isSidebarOpen && (
            <motion.div
              ...
              className="fixed lg:z-auto lg:static top-0 left-0 z-50
  w-72 lg:w-auto h-full lg:h-[75vh] lg:col-span-1 bg-black/90
  lg:bg-black/80 backdrop-blur-xl border border-white/10

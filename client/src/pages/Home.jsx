          ...
          >
            ...
            bg-gradient-to-br from-black/90 via-black/60 to-black/90 bg-clip-text text-transparent"
              ...
              style={{
                ...
                textShadow: "0 18px 40px rgba(0,0,0,0,0.5)",
              }}
            >
            ...
            <motion.p
              whileHover={{ y: -2 }}
              className="mt-6 max-w-xl text-lg bg-gradient-to-br from-gray-700 via-gray-500/80
to-gray-700 bg-clip-text text-transparent"
            ...
            flex items-center gap-3 bg-gradient-to-br from-black/90 via-black/80
            to-black/90  border border-white/10
...
function Feature({ icon, title, des }) {
  return (
    <motion.div
      ...
      className="relative rounded-2xl p-6 bg-gradient-to-br from-black/90 via-black/80
            to-black/90  backdrop-blur-2xl border border-white/10
            text-white shadow-[0_30px_80px_rgba(0,0,0,0.7)]"
      style={{ transformStyle: "preserve-3d" }}
    >

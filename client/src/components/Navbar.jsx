...
function Navbar() {
  ...
  return (
    ...
    to-black/80 backdrop-blur-2xl border border-white/10 shadow-[0_22px_55px_rgba(0,0,0,0.75)]
      ...
      <div className="flex items-center gap-6 relative">
        <div className="relative">
          <motion.div
            ...
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-1 px-2 py-2 rounded-full bg-white/10
    border border-white/20 text-white text-sm shadow-md cursor-pointer"
          >
          ...
          <AnimatePresence>
            {showCredits && (
              <motion.div
                ...
                className="absolute right-[-70px] mt-4 w-64 rounded-2xl
            bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)]
            p-4 text-white"
              >
        ...
        <div className="relative">
          <motion.div
            ...
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-1 px-4 py-2 rounded-full bg-white/10
    border border-white/20 text-white text-sm shadow-md cursor-pointer"
          >

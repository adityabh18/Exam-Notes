...
function Footer() {
  ...
  return (
    ...
    px-8 py-8 shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
    >
    ...
    bg-clip-text text-transparent"
          ...
          <p className="text-sm text-gray-300 max-w-sm">
            ...
            metarials, diagrams, and printable PDFs using AI.
          </p>
        </motion.div>
        ...
        <div className="text-center">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li
              ...
              className="text-red-400 hover:text-white transition-colors cursor-pointer hover:text-red-300"
            >
              SignOut
            </li>
            <li
